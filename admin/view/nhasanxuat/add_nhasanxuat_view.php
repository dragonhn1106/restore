<div class="content-wrapper right_col" id="right1">
    ...
    <?php } ?>
        <div class="row">
            <a href="?sk=nhasanxuat&m=index" class="btn btn-success" style="margin: 10px;"><i class="fa fa-th-list" aria-hidden="true"></i>&#160;&#160;Xem danh sách NSX</a>
            <h1 class="text-center">Thêm nhà sản xuất&nbsp;&nbsp;<i class="fa fa-user-plus" aria-hidden="true"></i></h1>
            <?php if(isset($mess) && !empty($mess)) { ?>
            <p class="text-center" style="font-weight: bold;"><?php echo $mess; ?></p>
            <?php } ?>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                <form class="form-horizontal" action="?sk=nhasanxuat&m=add" method="POST" accept-charset="utf-8" enctype="multipart/form-data" id="frmAddUserAdmin">
                    <div class="form-group">
                        <label for="txtUsername" class="col-sm-offset-2 col-sm-2 control-label">Tên nhà sản xuất</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="txtUsername" placeholder="Tên nhà sản xuất" name="txtUsername">
                        </div>
                    </div>
                    <div class="form-group">
