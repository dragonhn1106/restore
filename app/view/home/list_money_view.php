<div id="right">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-5">
                <h3 class="text-center" style="background-color:#98b827;color:white;"><i class="fa fa-bookmark" aria-hidden="true"></i>&#160;Sản phẩm theo giá tiền</h3>
            </div>
        </div>
    </div>
    <section class="grid-holder features-books">
        <?php foreach ($dataMoneyBook as $key => $value) {
            ?>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        $("#btnSearch").click(function(event) {
            ...
            var fmoney='<?php echo $fmoney?>';
            var tmoney='<?php echo $tmoney?>';
            window.location.href='<?php echo BASE_URL;?>' + '?cn=home&method=sach_theo_gia&fm=' + fmoney + '&tm=' + tmoney + '&page=' + page;
        });
    });
</script>